%!TEX program = xelatex
%windows、macOS用户都可用
\documentclass[UTF8, punct, oneside, fontset=none, song, on]{ctexbook}
...
\chapter[15pt]{\textbf{立项依据}

\vspace{2.5pt}（为什么要开展此项研究，研究的科学技术价值如何）}

\begin{MS}
	\input{sections/一依据}
\end{MS}

\chapter[8pt]{\textbf{研究内容}
	
\hspace{3pt}（提纲不做限制，请按照研究工作的自身逻辑撰写。应提炼出特 色与创新点、年度研究计划）}

\begin{MS}
	\input{sections/二内容}
\end{MS}

\chapter[8pt]{\textbf{研究基础}}
